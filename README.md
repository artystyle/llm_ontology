### Ключевые моменты  
Исследования показывают, что создание системы онтологии для нормативных документов с помощью больших языковых моделей (LLM) возможно, но требует тщательной оценки. Система, вероятно, должна включать обработку текста, извлечение концепций и отношений, а также оценку качества онтологии. Однако точные требования зависят от специфики документов и могут вызывать споры из-за сложностей с юридическим языком.  

---

### Обработка запроса  
#### Введение  
Создание системы онтологии для нормативных документов с использованием больших языковых моделей (LLM) — это сложный, но перспективный процесс. Онтология помогает структурировать знания из документов, таких как законы, регламенты или стандарты, для улучшения поиска, анализа и понимания. На основе последних научных публикаций можно системно оценить подходы и определить требования к системе.  
...
#### Заключение  
Анализ последних публикаций показывает, что LLM предоставляют мощные инструменты для создания онтологий нормативных документов, но требуют учета специфики юридического языка и обеспечения качества. Предложенные требования обеспечивают основу для разработки системы, способной эффективно структурировать знания и адаптироваться к различным сценариям использования.  
